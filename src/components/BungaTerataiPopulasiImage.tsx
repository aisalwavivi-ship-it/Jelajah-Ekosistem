 ...
 * Menampilkan visualisasi populasi bunga teratai (rumpun lebih dari satu individu teratai sejenis).
 * Dilengkapi dengan fallback SVG teratai yang indah jika berkas gambar tidak ditemukan.
 */
