      ...
      labels: [
        {
          ...
          level: 'individu',
          icon: '🐈',
          description: '1 ekor kucing mandiri yang sedang berjemur sendirian di bawah pohon mangga.',
        },
        {
          badgeId: 'B',
          ...
          level: 'populasi',
          icon: '🐜',
          description: 'Sekelompok puluhan semut merah sejenis yang berbaris bersama di batang pohon.',
        },
        {
          badgeId: 'C',
          name: 'Seluruh Makhluk Hidup Taman',
          level: 'komunitas',
          icon: '🌳🐈🪴🐜',
          description: 'Gabungan tanaman pohon mangga, rumput, kumpulan semut, dan kucing yang hidup berdampingan.',
        },
        {
          badgeId: 'D',
          name: 'Tanah Humus & Sinar Matahari',
          level: 'abiotik',
          icon: '☀️🪴',
          description: 'Benda dan faktor alam tak hidup yang menopang kehidupan taman sekolah.',
        },
      ],
    },
